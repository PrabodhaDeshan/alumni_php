                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarTables">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="add_new_members.php" class="nav-link" data-key="t-basic-tables">Add new
                                    members</a>
                            </li>
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarCharts">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="admin_password_change.php" class="nav-link" data-key="t-chartjs"> Password
                                    settings</a>
                            </li>
                            <li class="nav-item">
                                <a href="a_profile_settings.php" class="nav-link" data-key="t-chartjs"> profile
                                    settings</a>
                            </li>
